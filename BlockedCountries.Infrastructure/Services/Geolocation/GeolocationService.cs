...
namespace BlockedCountries.Infrastructure.Services.Geolocation
{
    public class GeolocationService : IGeolocationService
    {
        ...
        public async Task<IpCheckResult> CheckIfIpIsBlockedAsync(string clientIp, string userAgent)
        {
            ...
            if (string.IsNullOrEmpty(geo.Location.CountryCode))
                return new IpCheckResult(clientIp, "", null, false, null, "Could not determine country.");

            var countryCode = geo.Location.CountryCode.ToUpperInvariant();
